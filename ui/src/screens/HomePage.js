...
function ShortCutCard({title,onClick,color}){
  return(
<<<<<<< HEAD
    <Card className="mx-1 w-40 text-center" onClick={onClick} color={color}>
=======
      ...
      <div className="flex flex-col w-full px-5 justify-center items-center">
        ...
        <div className="flex justify-between m-1">
          ...
          <div className="flex flex-col mr-1">
            ...
            <ShortCutCard title="bill" color="red" />
            <div className="my-2 border-b border-blue-500"></div>
          ...
          <div className="flex flex-col ">
            ...
            <div className="my-2 border-b border-blue-500"></div>
            <ShortCutCard title="Purchase Order" color="red" />
            <div className="my-2 border-b border-blue-500"></div>
            <ShortCutCard title="Proforma Invoice" color="blue" />
          </div>
        </div>
      </div>
    </div>
